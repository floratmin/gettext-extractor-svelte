  ...
  describe('test js extractor function', () => {
    ...
    describe('Test comment options', () => {
      test('Test comment options parsing', () => {
        ...
        parser.parseString(
          `t('Foo', {comment: 'My Comment', props: { prop1: 'Prop1 is prop1', prop2: 'Prop2 is prop2'}, other: 'other comment',` +
    ...
    describe('Test other objects in between arguments', () => {
      ...
      test('Concatenated strings', () => {
        ...
        expect(messages).toEqual([
          ...
          {
            text: 'Foo',
            comments: ['path: https://www.example.com', '{PROP}: Prop 1', 'key1.key2: Keyed Comment'],
          },
        ]);
      });
    });
